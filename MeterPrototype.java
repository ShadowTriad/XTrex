...
//package MeterPrototype imports the java swing package so the class Meter can use text displays
...
//class MeterPrototype extends the jFrame class so the class Meter can use text displays
public class MeterPrototype extends JFrame
{
	...
	{		
		JFrame frame = new MeterPrototype ();
